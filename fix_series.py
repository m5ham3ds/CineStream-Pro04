...
# Find the start of "// Coming Soon Series"
start_idx = content.find("            // Coming Soon Series")
# Find the start of "if (showBottomSheet) {"
end_idx = content.find("if (showBottomSheet) {")

if start_idx != -1 and end_idx != -1:
    replacement = """            // Coming Soon Series
...
"""
    ...
    with open("app/src/main/java/com/example/ui/screens/series/SeriesScreen.kt", "w") as f:
        f.write(new_content)
    print("Fixed SeriesScreen.kt")
else:
    print("Could not find boundaries in SeriesScreen.kt")
