...
import re
old_profile_block = re.search(r"composable\(Screen\.Profile\.route\)\s*\{\s*ProfileScreen\(\s*onNavigateToAuth = \{[\s\S]*?navController\.navigate\(Screen\.Settings\.route\)\s*\}\s*\)\s*\}", content)
